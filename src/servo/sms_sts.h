...
public:
	...
	int write_pos_ex(uint8_t ID, int16_t Position, uint16_t Speed, uint8_t ACC = 0)
    {
        if(Position<0){
            Position = -Position;
            Position |= (1<<15);
	...
	int reg_write_pos_ex(uint8_t ID, int16_t Position, uint16_t Speed, uint8_t ACC = 0)
    {
        if(Position<0){
            Position = -Position;
            Position |= (1<<15);
	...
	void sync_write_pos_ex(uint8_t ID[], uint8_t IDN, int16_t Position[], uint16_t Speed[], uint8_t ACC[])
    {
	...
	int write_speed(uint8_t ID, int16_t Speed, uint8_t ACC = 0)
    {
        if(Speed<0){
            Speed = -Speed;
            Speed |= (1<<15);
	...
	int calibration_offset(uint8_t ID)
    {
